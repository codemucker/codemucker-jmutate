...
@NotThreadSafe
public class WriterBeanBuilder extends AbstractBeanWriter {

	private final String beanTypeName;
	
	public WriterBeanBuilder(String beanClassName) {
		this(new BeanBuilderOptions(), beanClassName);
	}
	
	public WriterBeanBuilder(BeanBuilderOptions options, String beanClassName){
